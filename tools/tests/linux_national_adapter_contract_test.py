...
REFERENCE_PATH = ROOT / ".claude" / "docs" / "linux-system-reference.md"
ADAPTER_DOC_PATH = ROOT / ".claude" / "docs" / "linux-national-adapters.md"
...
def test_adapter_source_register_covers_every_national_integration():
    adapter_doc = ADAPTER_DOC_PATH.read_text(encoding="utf-8")
    reference = REFERENCE_PATH.read_text(encoding="utf-8")
    required_sources = (
        "https://canonical.com/blog/infographic-ubuntu-from-2004-to-20-04-lts",
        "https://canonical.com/blog/20-years-of-partnership",
        "https://canonical.com/blog/what-is-an-ubuntu-lts-release",
        "https://info.muenchen.de/pia/vgst3/Staedtische%20Arbeitsplaetze/",
        "https://www.gendarmerie.interieur.gouv.fr/",
        "https://interoperable-europe.ec.europa.eu/collection/open-source-observatory-osor/",
        "https://www.planalto.gov.br/ccivil_03/dnn/2003/dnn10007.htm",
        "https://www.gov.br/governodigital/",
        "https://www.gov.br/iti/pt-br/assuntos/noticias/iti-na-midia/",
        "https://www.cdac.in/index.aspx?id=aboutus_Annual_Report13-14",
        "https://www.openeuler.org/en/news/20200101.html",
        "https://docs.openeuler.org/en/docs/common/faq/general/general_faq.html",
        "https://www.huawei.com/en/news/2020/3/openeuler-lts-open-source-operating-system",
        "https://www.ciudadccs.info/",
    )
