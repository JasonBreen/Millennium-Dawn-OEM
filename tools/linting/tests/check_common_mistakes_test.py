...
Unit tests for the checks added to check_common_mistakes.py (in file order):
  ...
  35. limit as a direct child of an else block
  36. province = { province = <id> } in add_building_construction
  37. log string carrying a second quoted run
  38. add_equipment_bonus without name/project, or an unknown bonus type
  39. equipment effects naming equipment nothing defines
  40. has_active_mission / has_active_decision naming no decision
  41. add_opinion_modifier / add_relation_modifier naming no modifier
"""
