...
class Validator(BaseValidator):
    ...
    def _limit_has_marker_guard(self, limit_body: str) -> bool:
        ...
        - Nested NOT -> OR -> marker sets: NOT = { OR = { has_country_flag = ... has_country_flag = ... } }
        - Mixed flag/idea NOT -> OR sets: NOT = { OR = { has_country_flag = ... has_idea = ... } }
