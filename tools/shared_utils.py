...
def is_excluded_path(path: str, excluded_dirs: Container[str], repo_root: str) -> bool:
    ...
    try:
        ...
        # Windows cannot form a relative path across drive letters. Direct CLI
        # targets on another drive still need the resources/.claude guard, so
        # fall back to their absolute components in that case.
