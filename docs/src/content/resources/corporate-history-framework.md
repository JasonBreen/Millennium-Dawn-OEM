...
The corporate-history framework powers the dated company chains (IBM, Sun/Microsoft, HP, Apple, NVIDIA, Dell, Google, Oracle, E3, Texas Instruments, Micron, Motorola, AIG, Lenovo, Huawei, Sony, Nintendo, ATI/AMD, Matrox, Nokia, TSMC, Foxconn, and, at dispatch level only, Siemens, Ericsson, and BlackBerry). It centralizes control flow, value bounds, and game-rule gating; each company binds its own names, dates, and deltas in thin wrapper effects.
