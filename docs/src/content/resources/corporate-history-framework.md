...
| `<TAG>_<co>_schedule_current_year_events` | per-year Jan-1 window guard + `country_event` offsets (implemented for Apple, Dell, E3, Texas Instruments, Micron, Motorola, Lenovo, Huawei, NVIDIA, ATI/AMD, Nokia, TSMC, Foxconn, Arm Holdings, and Ukrainian strategic industry, matching `requires_current_year_scheduler` in the manifest)                                                                                                                                                                                                                                                     |
