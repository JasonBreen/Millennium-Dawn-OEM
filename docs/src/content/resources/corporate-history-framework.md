...
The corporate-history framework powers the dated company chains (IBM, Sun/Microsoft, HP, Apple, NVIDIA, Dell, Google, Oracle, E3, Texas Instruments, Micron, Motorola, Lenovo, Sony, Matrox, Nokia, TSMC, Foxconn, and, at dispatch level only, Siemens, Ericsson, and BlackBerry). It centralizes control flow, value bounds, and game-rule gating; each company binds its own names, dates, and deltas in thin wrapper effects.
...
| `<TAG>_<co>_schedule_current_year_events` | per-year Jan-1 window guard + `country_event` offsets (implemented for Apple, E3, Texas Instruments, Micron, Motorola, Lenovo, NVIDIA, Nokia, TSMC, and Foxconn, matching `requires_current_year_scheduler` in the manifest)                                                                                                                                                                                                                                                                                                                        |
