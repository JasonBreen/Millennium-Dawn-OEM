...
| France        | The existing `FRA_nokia_response_events.1` remains the France-owned transaction interface. France adapter effects record the local branch; existing FIN events `.95` / `.96` remain the only cross-country callbacks. No France effect writes FIN state directly.                                                                                                                                                                                                                                                                                                                                      | `events/FRA_nokia_response_events.txt`, `common/scripted_effects/FRA_corporate_systems_effects.txt` |
...
| France Corporate Systems (FRA)                      | 1 _(approved national module)_ | 24 new visible events plus the existing Nokia response, 10 bounded variables, 5 outcome ideas, scheduler + reconstruction, read-only national dashboard                                                                                                        |
