...
| Per-company wrappers (init/clamp/reconstruct/schedule/capstone)                                                              | Per-chain files in `common/scripted_effects/`, including `FRA_corporate_systems_effects.txt`; exact inventory is enforced by `tools/corporate_history_contract.json`                                                                                                                                                                                                                                                                                                                                                                                                |
